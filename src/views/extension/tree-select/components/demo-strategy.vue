<template>
  <ele-card header="标签显示策略">
    ...
    >
      ...
      >
        <el-radio label="parent" style="margin: 0; display: flex; width: 100%">
          parent(当子节点全部选中时只显示父级)
        </el-radio>
        <el-radio label="child" style="margin: 0; display: flex; width: 100%">
          child(只显示选中的子节点)
        </el-radio>
        <el-radio label="all" style="margin: 0; display: flex; width: 100%">
          all(显示所有选中的节点)
        </el-radio>
      </el-radio-group>
    </option-item>
    <option-item label="值策略" :responsive="false" style="margin-top: 10px">
      <el-radio-group v-model="checkedValueStrategy">
        <el-radio :label="false">全部选中值</el-radio>
        <el-radio :label="true">同标签策略</el-radio>
      </el-radio-group>
    </option-item>
